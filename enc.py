...
COLORS = { 'GREEN': "\x0303", 'RED': "\x0304", 'BOLD': "\002" }
PROCESSING = False
PASSFILE = None
CHANNELS = set()
DEBUG = False
...
# Encrypt 'plaintext' through the openssl commandline client
...
# Decrypt 'cryptogram' through the openssl commandline client
...
# Invoked everytime a user sends a message
...
# Invoked everytime a message is received in a private dialog
